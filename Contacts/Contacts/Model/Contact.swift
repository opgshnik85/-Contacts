...
func save(contacts: [ContactProtocol]) {
    var arrayForStorage: [[String:String]] = []
        contacts.forEach { contact in
            var newElementForStorage: Dictionary<String, String> = [:]; newElementForStorage[ContactKey.title.rawValue] = contact.title; newElementForStorage[ContactKey.phone.rawValue] = contact.phone; arrayForStorage.append(newElementForStorage)
